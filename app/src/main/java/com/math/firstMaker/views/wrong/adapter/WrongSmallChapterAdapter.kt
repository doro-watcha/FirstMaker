...
import com.math.firstMaker.databinding.ItemWrongSmallChapterBinding
...
class WrongSmallChapterAdapter(
    private val item : MiddleChapter
) : RecyclerView.Adapter<WrongSmallChapterAdapter.SmallChapterViewHolder>() {

    private val TAG = WrongSmallChapterAdapter::class.java.simpleName
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SmallChapterViewHolder {
        ...
        val binding = ItemWrongSmallChapterBinding.inflate(inflater, parent, false)
    ...
    inner class SmallChapterViewHolder(private val binding: ItemWrongSmallChapterBinding) : RecyclerView.ViewHolder(binding.root) {
        init {
...
@BindingAdapter("app:recyclerview_wrong_small_chapter")
fun RecyclerView.setWrongSmallChapters(items: List<SmallChapter>?) {
    (adapter as? WrongSmallChapterAdapter)?.run {
